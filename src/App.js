      ...
      <React.Fragment>
        ...
        <main className="container">
          ...
          <AuthenticatedRoute
            user={user}
            path="/calendar"
            render={() => <CalendarComponent user={user} />}
          />
          ...
          <AuthenticatedRoute
            user={user}
            path="/capacity_building"
            render={() => (
              <Form
                setUser={this.setUser}
                page={'capacity_building'}
                pageName={'Capacity Building'}
                user={user}
              />
            )}
          />
          ...
          <AuthenticatedRoute
            user={user}
            path="/points_of_encounter"
            render={() => (
              <Form
                setUser={this.setUser}
                page={'points_of_encounter'}
                pageName={'Points Of Encounter'}
                user={user}
              />
            )}
          />
